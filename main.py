...
night_template_id = os.getenv('NIGHT_TEMPLATE_ID')
...
if night_template_id is None:
    print('请设置 NIGHT_TEMPLATE_ID')
    exit(422)
...
if __name__ == '__main__':
    ...
    try:
        for user_id in user_ids:
            res = wm.send_template(user_id, nignt_template_id, data)
            count += 1
    except WeChatClientException as e:
